...
public class ProductService {
    ...
    public void save(Principal principal, Product product, MultipartFile file1, MultipartFile file2, MultipartFile file3) throws IOException, NoPreviewImageException {
        Image image1 = toImage(file1);
        Image image2 = toImage(file2);
        Image image3 = toImage(file3);
        this.save(principal, product, image1, image2, image3);
    }
